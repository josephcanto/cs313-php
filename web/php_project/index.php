...
<body>
    ...
    <main>
        ...
        <section id='comic'>
            ...
            <div id='comic-images'>
                <img class='comic-strip' src='comic_1.png' alt='A digital drawing of a person thinking with a thought bubble with a lightbulb inside of it'>
                <img class='comic-strip' src='comic_2.png' alt='A digital drawing of a smartphone with the for-gift &amp; forget app open on the screen'>
                <img class='comic-strip' src='comic_3.png' alt='A digital drawing of a person giving another person a gift on his birthday'>
            </div>
        ...
        <section id='testimonials-container'>
            ...
            <div id='testimonials'>
                <div class='testimonial'>
                    <h4>John M.</h4>
                    <img class='person-image' src='person_icon.jpg' alt='A picture of a man smiling'>
                ...
                <div class='testimonial'>
                    <h4>Alissa C.</h4>
                    <img class='person-image' src='person_icon.jpg' alt='A picture of a woman smiling'>
